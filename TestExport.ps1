...
Version# 1.0
Script log file: C:\DATA2\BusinessApplications\VectorSolutions\Archive\VectorSolution_log.txt
#>

$CurrentDate = Get-Date
$Logfile = "C:\DATA2\BusinessApplications\VectorSolutions\Archive\VectorSolutions_log.txt"
$winscplog = "C:\DATA2\BusinessApplications\VectorSolutions\Archive\winscp_log.txt"
$Filename1 = "vectorsolutions.csv"
#$EmailTo = @('Workflow-ITDATA@susd.org')
$EmailTo = @('mmajercin@susd.org')
$Createtime = (Get-Item C:\DATA2\BusinessApplications\VectorSolutions\Datafiles\$Filename1).LastWriteTime
...
Compress-Archive -Path C:\DATA2\BusinessApplications\VectorSolutions\Datafiles\* -CompressionLevel Fastest -DestinationPath C:\DATA2\BusinessApplications\VectorSolutions\Archive\$CurrentDate.zip -Force

$logoutput = $logoutput + "Starting WinSCP..`r`n"
c:\"Program Files (x86)"\WinSCP\winscp.com /command "option confirm off" "option batch abort" "open VectorSolutions" "put C:\DATA2\BusinessApplications\VectorSolutions\DataFiles\* /" "exit" >> $winscplog
Sleep 10
...
{
$Ftpcreatetime = (Get-Item "C:\DATA2\BusinessApplications\VectorSolutions\Archive\$CurrentDate.zip").LastWriteTime
...
$Folder = "C:\DATA2\BusinessApplications\VectorSolutions\Archive"
$limit = (Get-Date).AddDays(-30)
$log_path = "C:\DATA2\BusinessApplications\VectorSolutions\Archive\deleted_log.txt"
$log_count = 0
